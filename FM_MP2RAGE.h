...
//        Lang: C++
//
//     Descrip: Deklarations for fm_radial.cpp
//
//
...
///         - Flash1
///
/// This file contains the declaration of the class fm_radial.
...
//  --------------------------------------------------------------------------
//
/// \brief <b> Class definition of fm_radial. This class is used by the sequences
///         - fm_radial
///         - Flash1    </b>
///
/// This file contains the declaration of the class fm_radial.
...
* - Flash1
*/
	class fm_radial : public StdSeqIF
	{

	public:
		/**
		* @brief Standard constructor of the fm_radial sequence object. The class members are initialized
		* with default values.
		*/
		fm_radial();
		...
		/**
		* @brief Destructor of the fm_radial sequence object. The fm_radialUI object is destructed as well.
		*/
		virtual ~fm_radial();
		...
		//
		//  Description :
		/// \brief <b>     Returns the pointer to the fm_radial UI class  </b>
		///
		...
		//
		//  --------------------------------------------------------------
		const fm_radialUI* getUI (void) const;
	...
	protected:
	   ...
	   // Variables for trigger mode
		...
		sFREQ_PHASE            m_sADCsgNeg                  ; //FM_RADIAL
		...
		//  --------------------------------------------------------------
		/// \brief <b> UI class for fm_radial
		///
	...
	private:
		...
		//  ------------------------------------------------------------------
		fm_radial (const fm_radial &right);
		...
		//  ------------------------------------------------------------------
		fm_radial & operator=(const fm_radial &right);
