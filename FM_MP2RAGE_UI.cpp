...
//
//     Project: NUMARIS/4
//        File: \n4_servers1\pkg\MrServers\MrImaging\seq\FM_MP2RAGE\FM_MP2RAGE_UI.cpp
//     Version:
//      Author: Clinical
//        Date: n.a.
//
//        Lang: C++
//
//     Remarks: This is the demo sequence FM_MP2RAGEUI.
...
using namespace SEQ_NAMESPACE;
    ...
    //
    //  ----------------------------------------------------------------------
    FM_MP2RAGE* getSeq (MrUILinkBase* const pThis)
    {
        return ( static_cast<FM_MP2RAGE*>(pThis->sequence().getSeq()) );
    }
    ...
    //
    //  ----------------------------------------------------------------------
    const FM_MP2RAGEUI* getUI (MrUILinkBase* const pThis)
    {
        return ( static_cast<FM_MP2RAGE*>(pThis->sequence().getSeq())->getUI() );
    }
   ...
   //+ **************************************************************************
    ...
    NLS_STATUS FM_MP2RAGEUI::registerUI (SeqLim &rSeqLim)
    {

        static const char * const ptModule = {"FM_MP2RAGEUI::registerUI"};
